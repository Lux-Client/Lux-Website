...
const createCloudTables = async (connection) => {
    ...
    `);
    await connection.query('CREATE INDEX IF NOT EXISTS idx_device_pairing_user_code ON device_pairing_codes(user_code)');
    ...
    console.log('[Database] users cloud ban columns checked/added.');
